...
class GANLoss(nn.Module):
    ...
    def __init__(self, gan_mode, target_real_label=1.0, target_fake_label=0.0, device='cpu'):
...
class PerceptualLoss(nn.Module):
    ...
    def __init__(self, network='vgg19', layers='relu_4_1', weights=None,
                 ...
                 use_style_loss=False, weight_style_to_perceptual=0, device='cpu'):
        super().__init__()
...
class CrossEntropyLoss(nn.Module):
    ...
    def forward(self, pred, truth):
        return - torch.sum((torch.log(pred) * truth))/pred.shape[0]
